<%@ page language="java" import="java.io.*,java.util.*,cloudFinal.*,java.sql.*,java.util.Map.Entry,java.util.HashMap.*" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
  <%
  ...
  String cr = roomMap.get(checkRoom);
  	while(rs.next()){
  		...
  		if(!libCountMap.containsKey(strArr[0])){
  			...
  			libCountMap.replace(strArr[0], libCountMap.get(strArr[0])+Integer.parseInt(strArr[1]));
  		}
  	}
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<p style="text-align: right; font-size: 160%; color: white; font-family: Palatino Linotype">
				<%if(checkRoom == null){%>
					Hi! <%=usr%>
				<%}
				else{%>		
					Hi! <%=usr%>, you are at: <%=cr %> now! Wrong?  <a style="color: white;" href="checkOutServlet?checkout=yes"><ins><small>Check Out</small></ins></a>
				<%}%>
